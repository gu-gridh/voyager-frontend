    ...
    <v-container>
      <v-row>
        <v-col>
          ...
          <v-card color="" style="border-radius:0 0 15px 15px; box-shadow: 0rem 1rem 1rem rgba(0, 0, 0, 0.2); background-color:rgba(255,255,255,0.7);   backdrop-filter: blur(10px);">
